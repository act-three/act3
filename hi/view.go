...
type View interface {
	...
	// Dialog displays the given view in a model dialog box centered
	// in the browser viewport.
	//
	// The PresentationState controls whether the dialog box is shown.
	// The dialog uses the given view's title as its accessibility label.
	//
	//	Button(OpenSettings{}, Text("Settings")).
	//		Dialog(Present(app.settingsIsOpen, CloseSettings{}),
	//			app.settingsView().
	//				Title("Settings"),
	//		)
	Dialog(PresentationState, View) View
	...
	// Menu displays the given view in a menu attached to the receiver.
	//
	// The PresentationState controls whether the menu is shown.
	// The menu uses the given view's title as its accessibility label.
	//
	//	Button(OpenMenu{}, Text("More")).
	//		Menu(Present(app.menuIsOpen, CloseMenu{}),
	//			VStack(
	//				Button(FileNew{}, Text("New")),
	//				Button(FileOpen{}, Text("Open…")),
	//				Button(FileSave{}, Text("Save")),
	//			),
	//		)
	Menu(PresentationState, View) View

	// Popover displays the given view in a popover attached to
	// the receiver.
	//
	// The PresentationState controls whether the popover is shown.
	// The popover uses the given view's title as its accessibility label.
	Popover(PresentationState, View) View
	...
	// Title adds a title to the returned view. If the receiver
	// already has a title, Title has no effect.
	//
	// View titles are used by enclosing views and the application
	// instance to provide accessibility labels and the page title.
	Title(string) View
